...
### 🧩 `ER Diagram`
The ER diagram file in SQL_Files/World_Wide_Energy_Consumption_ER_Diagram.png represents the overall database design — showing how each table connects through the country attribute.
